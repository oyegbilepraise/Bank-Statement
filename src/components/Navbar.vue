    ...
    <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
      <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
          <a href="#">
            <img
              src="https://creditclan.com/images/logo-small.png"
              width="50"
              height="32"
              alt="Tabler"
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link">
                ...
                <router-link to="/" class="nav-link-title"> Apps </router-link>
              </a>
            </li>
            <li class="nav-item">
              <a href="/users" class="nav-link">
                <i class="fa fa-user mx-1" aria-hidden="true"></i>
                <router-link to="/users" class="nav-link-title ml-2"> Users </router-link>
              </a>
            </li>
          </ul>
        </div>
